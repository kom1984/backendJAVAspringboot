...
public class Client implements Serializable {
    ...
    @OneToOne(cascade = CascadeType.ALL)
    @JoinColumn(name = "permisConduire_id", referencedColumnName = "idPermis")
	...
	public Client(String nom, String prenom, String adresse, String cp, String ville, String pays, Vehicule vehicule,
			List<Commande> commandeList, List<Location> locationList, PermisConduire permisConduire,
	...
	public Client(Long id, String nom, String prenom, String adresse, String cp, String ville, String pays,
			Vehicule vehicule, List<Commande> commandeList, List<Location> locationList, PermisConduire permisConduire,
			List<Agence> agenceList) {
		super();
		this.id = id;
		this.nom = nom;
	...
	public void setPermisConduire(PermisConduire permisConduire) {
		this.permisConduire = permisConduire;
	}
